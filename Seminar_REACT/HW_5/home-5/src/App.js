...
function App() {
  ...
  return (
    <div>
        <ThemeSwitcher />
        <p className={`${theme}`}>Приложение для переключения темы сайта
...
Интерфейс: Ваш интерфейс может состоять из переключателя, который изменяет тему с светлой на темную и обратно.</p>
    </div>
  );
}
